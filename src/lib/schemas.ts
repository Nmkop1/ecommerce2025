...
//     .array()
//     .min(1, "Please provide at least one color.").optional(),
//   sizes: z
//     .object({
//       size: z.string(),
//       quantity: z
...
export const ProductFormSchema = z.object({
  name: z
    ...
    .min(1, { message: "Product name should be at least 2 characters long." })
    .max(200, { message: "Product name cannot exceed 200 characters." }),
  /*
    .regex(/^(?!.*(?:[-_ &' ]){2,})[a-zA-Z0-9_ '&-]+$/, {
      message:
  ...
  freeShippingCountriesIds: z
    ...
    .default([]),
  shippingFeeMethod: z.nativeEnum(ShippingFeeMethod).optional(),
});



export const ProductFormSchemaEdycja = z.object({
